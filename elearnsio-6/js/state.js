...
// ═══ NAV TABS ═══
var TABS=[
  {id:"s-map",  i:'<i data-lucide="map"        style="width:22px;height:22px;stroke:currentColor"></i>', l:"Map"},
  {id:"s-log",  i:'<i data-lucide="book-open"  style="width:22px;height:22px;stroke:currentColor"></i>', l:"Logbook"},
  {id:"s-rt",   i:'<i data-lucide="history"    style="width:22px;height:22px;stroke:currentColor"></i>', l:"Routes"},
  {id:"s-prof", i:'<i data-lucide="user"       style="width:22px;height:22px;stroke:currentColor"></i>', l:"Profile"}
];
