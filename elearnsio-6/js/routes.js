...
// ═══ POI ═══
var POI_MAP={
  "parking":{q:'["amenity"="parking"]',icon:"<i data-lucide="square-parking" style="width:22px;height:22px;stroke:currentColor"></i>",css:"poi-parking",label:"Parking Lot"},
  "roundabouts":{q:'["junction"="roundabout"]',icon:"<i data-lucide="refresh-cw" style="width:22px;height:22px;stroke:currentColor"></i>",css:"poi-roundabout",label:"Roundabout"},
  "hills":{q:'["natural"="peak"]',icon:"<i data-lucide="mountain" style="width:22px;height:22px;stroke:currentColor"></i>",css:"poi-hill",label:"Hill / Incline"},
  ...
  "multi-lane":{q:'["highway"="traffic_signals"]',icon:"<i data-lucide="traffic-cone" style="width:22px;height:22px;stroke:currentColor"></i>",css:"poi-traffic",label:"Traffic Signals"}
};
...
function showResult(){
  ...
  // Primary action row
  h+='<div class="ar">';
  h+='<button class="btn ba" id="rgo"><i data-lucide="play" style="width:15px;height:15px;stroke:var(--bg0)"></i> Start Drive</button>';
  h+='<button class="btn bs" id="rprev" style="flex:none;padding:12px 16px"><i data-lucide="eye" style="width:15px;height:15px;stroke:var(--t1)"></i> Preview</button>';
  h+='<button class="btn bs" id="rexp" style="flex:none;padding:12px 16px"><i data-lucide="share-2" style="width:15px;height:15px;stroke:var(--t1)"></i></button>';
  h+='</div>';
