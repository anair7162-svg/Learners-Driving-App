// ═══ WIZARD ═══
var RD=[
  {k:"residential", i:'<i data-lucide="home"           style="width:22px;height:22px;stroke:currentColor"></i>', n:"Residential", d:"Quiet suburban roads"},
  {k:"main-roads",  i:'<i data-lucide="route"          style="width:22px;height:22px;stroke:currentColor"></i>', n:"Main Roads",   d:"Arterial, traffic lights"},
  {k:"multi-lane",  i:'<i data-lucide="traffic-cone"   style="width:22px;height:22px;stroke:currentColor"></i>', n:"Multi-Lane",   d:"Dual carriageways"},
  {k:"roundabouts", i:'<i data-lucide="refresh-cw"     style="width:22px;height:22px;stroke:currentColor"></i>', n:"Roundabouts",  d:"Single & multi-lane"},
  {k:"parking",     i:'<i data-lucide="square-parking" style="width:22px;height:22px;stroke:currentColor"></i>', n:"Parking",      d:"Reverse & angle"},
  {k:"hills",       i:'<i data-lucide="mountain"       style="width:22px;height:22px;stroke:currentColor"></i>', n:"Hills",        d:"Steep grades"}
];
...
function dW(){
  ...
  if(s===0){
    ...
    h+='<div class="wn"><button class="btn bs" style="flex:1" id="wbk">← Back</button><button class="btn ba" style="flex:1" id="wgen"><i data-lucide="zap" style="width:15px;height:15px;stroke:var(--bg0)"></i> Generate Routes</button></div>';
  }
  p.innerHTML=h;bW();
}
function bW(){
