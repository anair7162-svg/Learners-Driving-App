...
function showWelcome(){
  $("sh").innerHTML='<h3><i data-lucide="map-pin" style="width:16px;height:16px;stroke:var(--acc)"></i> You are here</h3><p style="font-size:12px;color:var(--t2);margin-bottom:12px;line-height:1.5">Search a location to add waypoints, or build a loop directly.</p><div id="wx-slot"></div><div class="ar"><button class="btn ba" id="sh-b"><i data-lucide="refresh-cw" style="width:15px;height:15px;stroke:var(--bg0)"></i> Build Loop Route</button></div>';
